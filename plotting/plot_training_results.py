...
best_model_predictions.loc[best_model_predictions.PREDICTION_MEAN < threshold, 'PREDICTION_MEAN_CLASS'] = 0
best_model_predictions.loc[best_model_predictions.PREDICTION_MEAN >= threshold, 'PREDICTION_MEAN_CLASS'] = 1
