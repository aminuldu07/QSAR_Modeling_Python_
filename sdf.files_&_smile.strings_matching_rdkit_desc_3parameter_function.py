#  A function named "process_sdf_files" that takes three parameters: "sdf_directory" and "output_directory" and "smiles_csv_path" 
...
def process_sdf_files(sdf_directory, output_directory, smiles_csv_path):
...
df = process_sdf_files(sdf_directory, output_directory, smiles_csv_path)
print(df)
